class COA_ListBoxElementComponent: SCR_ListBoxElementComponent
{
	...
	COA_Gamemode m_Gamemode = COA_Gamemode.GetInstance();  // Game mode instance reference
	 ...
	 * Thresholds mirror COA_CommunityTagManager RANK_XP_E* constants.
	 */
