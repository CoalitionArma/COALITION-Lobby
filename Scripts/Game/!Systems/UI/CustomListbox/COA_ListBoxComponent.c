class COA_ListboxComponent: SCR_ListBoxComponent
{
	/**
	...
	{	
		COA_ListBoxElementComponent comp;
	 ...
	 * @return Index of the added item
	 */
	protected int _AddItemSpecSlot(Managed data, out COA_ListBoxElementComponent compOut, int slotId = -1)
	{
		...
		COA_ListBoxElementComponent comp = COA_ListBoxElementComponent.Cast(newWidget.FindHandler(COA_ListBoxElementComponent));
	 ...
	 * @return Index of the added item
	 */
	protected int _AddItemSlot(Managed data, out COA_ListBoxElementComponent compOut, int slotId = -1, ResourceName overrideLayout = "")
	{	
		...
		if (overrideLayout != "") {
			...
			bool notInAARState = COA_Gamemode.GetInstance().m_GamemodeState != COA_EGamemodeState.AAR;
	 ...
	 * @return Index of the added item
	 */
	protected int _AddItemSpecGroup(Managed data, out COA_ListBoxElementComponent compOut, SCR_AIGroup group = null, ResourceName groupIcon = "")
	{
	 ...
	 * @return Index of the added item
	 */
	protected int _AddItemChannel(Managed data, out COA_ListBoxElementComponent compOut, string channelName)
	{
	 ...
	 * @return Index of the added item
	 */
	protected int _AddItemGroup(Managed data, out COA_ListBoxElementComponent compOut, SCR_AIGroup group = null, ResourceName overrideLayout = "", ResourceName groupIcon = "")
	{	
	 ...
	 */
	protected void SetupWidgetNavigation(Widget newWidget, COA_ListBoxElementComponent comp)
	{
		// Set up explicit navigation rules for elements
		// This ensures we can navigate through separators when at the edge of scrolling
		// if there's an element directly above/below the listbox that intercepts focus
	 ...
	 */
	COA_ListBoxElementComponent GetCRFElementComponent(int item)
	{
