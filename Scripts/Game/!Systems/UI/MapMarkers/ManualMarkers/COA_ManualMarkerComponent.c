...
class COA_ManualMarkerComponent : SCR_ScriptedWidgetComponent
{
	protected SCR_MapEntity m_MapEntity;
	protected COA_ManualMarker m_ManualMarker;
	...
	void SetManualMarker(COA_ManualMarker marker)
	{
	...
	// Every info contains in COA_ManualMarker, soo ther is onle setters
