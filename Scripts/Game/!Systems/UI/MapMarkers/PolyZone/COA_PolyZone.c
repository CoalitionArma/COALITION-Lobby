...
class COA_PolyZoneClass: ScriptComponentClass
{
};

[ComponentEditorProps(icon: HYBRID_COMPONENT_ICON)]
class COA_PolyZone : ScriptComponent
{
//=============================================================================================================================================================================================================================================================================================================================================================
//	 ATTRIBUTES
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	[Attribute("0", UIWidgets.ComboBox, "", "", ParamEnumArray.FromEnum(COA_EGamemodeState))]
	ref array<COA_EGamemodeState> m_aHideOnGameModeStates;
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	protected COA_PolyZoneMeshComponent m_PolyZoneMeshComponent;
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	override void OnPostInit(IEntity owner)
	{
		...
		{
			Print(string.Format("[COA_PolyZone] ERROR: Component attached to non-ShapeEntity! Owner: %1", owner), LogLevel.ERROR);
			return;
		}
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	//------------------------------------------------------------------------------------------------
	void RegisterMeshComp(COA_PolyZoneMeshComponent comp)
	{
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	void UpdatePolygon()
	{
		...
		if (!m_ePolylineShapeEntity)
		{
			Print("[COA_PolyZone] ERROR: m_ePolylineShapeEntity is NULL. Owner entity must be a ShapeEntity!", LogLevel.ERROR);
			return;
		}
