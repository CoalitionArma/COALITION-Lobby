//------------------------------------------------------------------------------------
// COA_GroupLeaderMarkerManager: Manager for group leader 3D markers during safestart
...
class COA_GroupLeaderMarkerData
{
	...
	//------------------------------------------------------------------------------------------------
	void COA_GroupLeaderMarkerData()
	{
		m_sGroupName = "";
...
class COA_GroupLeaderMarkerManager: SCR_BaseGameModeComponent
{
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	protected COA_RplBroadcastManager m_BroadcastManager;
	...
	protected ref map<int, ref COA_GroupLeaderMarkerData> m_mPlayerMarkers = new map<int, ref COA_GroupLeaderMarkerData>();
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	override void OnPostInit(IEntity owner)
	{
		...
		m_BroadcastManager = COA_RplBroadcastManager.GetInstance();
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	void CreateMarkerForPlayerRPC(int playerId, string groupName)
	{
		...
		// Create marker data
		COA_GroupLeaderMarkerData markerData = new COA_GroupLeaderMarkerData();
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	protected void UpdateMarkerPositions()
	{
		...
		foreach (int playerId, COA_GroupLeaderMarkerData markerData : m_mPlayerMarkers)
		{
	...
	protected void UpdateMarkerForPlayer(int playerId)
	{
		...
		COA_GroupLeaderMarkerData markerData = m_mPlayerMarkers.Get(playerId);
	...
	protected Widget CreateMarkerWidget(Widget parent, COA_GroupLeaderMarkerData markerData)
	{
	...
	protected void SetMarkerHidden(COA_GroupLeaderMarkerData markerData)
	{
	...
	protected void UpdateMarkerBackgroundSize(COA_GroupLeaderMarkerData markerData)
	{
	...
	//! \param[in] playerId Player ID
	//! \param[in] markerData Marker data
	protected void UpdateMarkerDisplay(int playerId, COA_GroupLeaderMarkerData markerData)
	{
		if (!m_PlayerManager)
			return;
	...
	//! \param[in] markerData Marker data
	protected void UpdateWorldPosition(IEntity playerEntity, COA_GroupLeaderMarkerData markerData)
	{
		if (!playerEntity)
			return;
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	//------------------------------------------------------------------------------------------------
	protected static COA_GroupLeaderMarkerManager m_sInstance;
	void COA_GroupLeaderMarkerManager(IEntityComponentSource src, IEntity ent, IEntity parent)
	{
		m_sInstance = this;
	}

	//------------------------------------------------------------------------------------------------
	void ~COA_GroupLeaderMarkerManager()
	{
		if (m_sInstance == this)
			m_sInstance = null;
	}
	...
	//------------------------------------------------------------------------------------------------
	static COA_GroupLeaderMarkerManager GetInstance()
	{
		return m_sInstance;
	}
}
