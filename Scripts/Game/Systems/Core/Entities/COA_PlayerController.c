class COA_PlayerControllerClass : SCR_PlayerControllerClass
{
}

class COA_PlayerController : SCR_PlayerController
{	
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	override protected void UpdateLocalPlayerController()
	{
		...
		if (RplSession.Mode() == RplMode.Dedicated || !COA_Gamemode.GetInstance() || !COA_PlayerControllerManager.GetInstance())
			return;
		
		COA_PlayerControllerManager.GetInstance().InitilizePlayerControllerComp();
	}
