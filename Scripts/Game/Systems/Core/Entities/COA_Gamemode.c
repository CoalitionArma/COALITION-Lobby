...
//------------------------------------------------------------------------------------
// COA_GamemodeClass: Base class definition for the Coalition Reforger Framework Gamemode
//------------------------------------------------------------------------------------
class COA_GamemodeClass : SCR_BaseGameModeClass {}

//------------------------------------------------------------------------------------
// COA_Gamemode: Main gamemode controller for Coalition Reforger Framework
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	[Attribute("true", UIWidgets.Auto, desc: "Should we enable debug methods", category: "Debug Settings - Advanced")]
	bool m_EnableDebug;
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	[RplProp()]
	int m_SlottingState = COA_ESlottingState.LEADERSANDMEDICS;
	...
	//------------------------------------------------------------------------------------
	protected ref array<COA_PlayerCharacter> m_aActiveCharacters = new array<COA_PlayerCharacter>;
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	void AdvanceGamemodeState(bool overriden = false)
	{
		...
		if ((m_GamemodeState == COA_EGamemodeState.AAR || m_GamemodeState == COA_EGamemodeState.GAME) && !overriden)
			return;
	...
	//! since those run before this is called (see OnGamemodeStateChanged, COA_EGamemodeState.GAME).
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	protected override void OnPlayerDisconnected(int playerId, KickCauseCode cause, int timeout)
	{
		...
		if (COA_EntityHelper.IsSpectator(player)) // We need to delete all spectator characters on disconnect
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	protected void ProcessPlayerBatch()
	{
		...
		Print(string.Format("[Coalition Lobby] Processing batch: %1 players (%2 remaining)", 
		...
		for (int i = playersToProcess - 1; i >= 0; i--)
		{
			...
			{
				Print(string.Format("[Coalition Lobby] WARNING: Dropping player %1 from initialization queue after %2 failed attempts", playerId, retryCount), LogLevel.WARNING);
				m_mPlayerInitializationRetries.Remove(playerId);
				m_aPendingPlayerInitializations.Remove(i);
			}
		}
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	{
		m_vGenericSpawn = COA_MissionHelper.GetAOCenter();
		Replication.BumpMe();
	}
	...
	{
		COA_GearScriptContainer container = GetGearScriptSettings(factionKey);
		if (!container)
		{
	...
	COA_GearScriptContainer GetGearScriptSettings(FactionKey factionKey)
	{
		switch (factionKey)
		{
...
//=============================================================================================================================================================================================================================================================================================================================================================
//	 ACTIVE CHARACTER ACCESSORS/SETTERS
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	//------------------------------------------------------------------------------------
	void AddActiveCharacter(COA_PlayerCharacter character)
	{
		if (!m_aActiveCharacters.Contains(character))
			m_aActiveCharacters.Insert(character);
	}
	
	//------------------------------------------------------------------------------------	
	void RemoveActiveCharacter(COA_PlayerCharacter character)
	{
		if (m_aActiveCharacters.Contains(character))
			m_aActiveCharacters.RemoveItem(character);
	}
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	//------------------------------------------------------------------------------------------------
	protected static COA_Gamemode m_sInstance;
	void COA_Gamemode(IEntitySource src, IEntity parent)
	{
		m_sInstance = this;
	}
	...
	//------------------------------------------------------------------------------------------------
	static COA_Gamemode GetInstance()
	{
		return m_sInstance;
	}
}
