class COA_ModeratorConfig
{
	static ref COA_ModeratorConfigStruct m_config;
	static string m_configFilePath = "$profile:COA_ModeratorConfig.json";
	...
	{		
		...
		m_config = new COA_ModeratorConfigStruct();
...
class COA_ModeratorConfigStruct
{
