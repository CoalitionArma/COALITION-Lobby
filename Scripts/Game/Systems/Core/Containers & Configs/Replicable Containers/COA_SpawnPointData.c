...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	[Attribute("0", UIWidgets.SearchComboBox, enums: ParamEnumArray.FromEnum(COA_EFactions))]
	protected COA_EFactions m_iSpawnPointFaction;
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	//------------------------------------------------------------------------------------------------
	//! Replaces or sets the internal COA_SpawnPointData record for the id.
	//! If newSpawnData is non-null, the spawns data is updated with the provided instance.
	//! \param[in] newSpawnData: Pointer/reference to the new COA_SpawnPointData to apply.
	void DataUpdate(COA_SpawnPointData newSpawnData = null)
	{	
		if(newSpawnData)	
		{
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	//------------------------------------------------------------------------------------------------
	void SetSpawnPointFaction(COA_EFactions spawnPointFaction)
	{
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	//------------------------------------------------------------------------------------------------
	COA_EFactions GetSpawnPointFaction()
	{
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	//------------------------------------------------------------------------------------------------
	static bool Extract(COA_SpawnPointData instance, ScriptCtx ctx, SSnapSerializerBase snapshot)
	{
	...
	//------------------------------------------------------------------------------------------------
	static bool Inject(SSnapSerializerBase snapshot, ScriptCtx ctx, COA_SpawnPointData instance)
	{
		snapshot.SerializeBytes(instance.m_bSpawnPointActive, 4);
		snapshot.SerializeString(instance.m_sSpawnPointName);
		snapshot.SerializeString(instance.m_sRestrictedToGroup);
	...
	//------------------------------------------------------------------------------------------------
	static bool PropCompare(COA_SpawnPointData instance, SSnapSerializerBase snapshot, ScriptCtx ctx)
	{
