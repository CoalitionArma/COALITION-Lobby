class COA_PlayerScriptedMarkerManagerClass : ScriptComponentClass {}

class COA_PlayerScriptedMarkerManager : ScriptComponent
{	
	// Map and Markers
...
//=============================================================================================================================================================================================================================================================================================================================================================
	...
	//------------------------------------------------------------------------------------------------
	protected static COA_PlayerScriptedMarkerManager m_sInstance;
	void COA_PlayerScriptedMarkerManager(IEntityComponentSource src, IEntity ent, IEntity parent)
	{
		m_sInstance = this;
	}

	//------------------------------------------------------------------------------------------------
	void ~COA_PlayerScriptedMarkerManager()
	{
		if (m_sInstance == this)
			m_sInstance = null;
	}
	...
	//------------------------------------------------------------------------------------------------
	static COA_PlayerScriptedMarkerManager GetInstance()
	{
		return m_sInstance;
	}
}