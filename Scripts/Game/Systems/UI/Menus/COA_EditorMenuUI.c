modded class EditorMenuUI
{
	...
	COA_PlayerControllerManager m_PlayerControllerManager;
	...
	{
		super.OnMenuOpen();
		m_PlayerControllerManager = COA_PlayerControllerManager.GetInstance();
	...
	{
		CloseConfirmAction();
		COA_PlayerRplToAuthorityManager.GetInstance().CleanUpBodies();
	}
	...
	override void OnMenuClose()
	{
		...
		COA_PlayerRplToAuthorityManager.GetInstance().TogglePlayerListening(SCR_PlayerController.GetLocalPlayerId(), false);
		CloseConfirmAction();
	}
	...
	void ToggleListen()
	{
		...
		COA_PlayerRplToAuthorityManager.GetInstance().TogglePlayerListening(SCR_PlayerController.GetLocalPlayerId(), m_PlayerControllerManager.m_bIsListeningToSpec);
	}
}