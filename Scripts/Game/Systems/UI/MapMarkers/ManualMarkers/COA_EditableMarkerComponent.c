...
class COA_EditableMarkerComponentClass: SCR_EditableDescriptorComponentClass
{
	
};

class COA_EditableMarkerComponent: SCR_EditableSystemComponent
{
	COA_ManualMarker m_eManualMarker;
	
	override void OnPostInit(IEntity owner)
	{
		super.OnPostInit(owner);
		m_eManualMarker = COA_ManualMarker.Cast(owner);
	}
