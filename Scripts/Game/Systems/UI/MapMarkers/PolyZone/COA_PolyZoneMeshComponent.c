class COA_PolyZoneMeshComponentClass : ScriptComponentClass
{}

class COA_PolyZoneMeshComponent : ScriptComponent
{
	...
	override void OnPostInit(IEntity owner)
	{
		...
		{
			COA_PolyZone polyZone = COA_PolyZone.Cast(m_eShapeEntity.FindComponent(COA_PolyZone));
