...
{	
	...
	protected bool ButtonNext()
	{
		...
		foreach (int i, COA_MissionDescriptor descriptor : m_aMissionDescriptors)
		{
			...
			if (descriptorOffset > (gamemode.m_aMissionDescriptors.Count() - 1))
				api.CreateObjectArrayVariableMember(entitySource, null, "m_aMissionDescriptors", "COA_MissionDescriptor", descriptorOffset);
